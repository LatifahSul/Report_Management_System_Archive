...
?>
   ...
   if($_GET['did']){
      ...
      $result = mysqli_query($con, $sql);
        ...
        <form action='edit_report_user_database.php?did=". $_GET['did'] ."' method='POST' class='container' enctype='multipart/form-data'>
          <h1>Report</h1>";
...
<script>
    /**
     * This method to create radio button for each user permissions
     */
