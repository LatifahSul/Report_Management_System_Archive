...
<body>
    ...
    include 'database_connection.php';
        ...
        <form action='create_user_database.php' method='POST' class='container'>
          <h1>User</h1>";
        ...
        echo "<input type='text' type='hidden' placeholder='Enter Password' name='password'>";

        echo "<label for='first_name'><b>First Name</b></label>";
        echo "<input type='text' placeholder='Enter First Name' name='first_name'>";

        echo "<label for='last_name'><b>Last Name</b></label>";
        echo "<input type='text' placeholder='Enter Last Name' name='last_name'>";

        echo "<label for='permissions'><b>Permissions</b></label>";
        echo "<input type='text' placeholder='Enter Permissions' id='Permission1' name='permissions'>";
        ...
        echo "<button type='submit' name='send' class='btn'>Create</button>";
        echo " </form>";
        echo " </div>";
